...
# Visual offset (simulates line thickness separation)
GAP = 0.05
...
def draw_wall(Ha, Hw, Hp, Th, Tt, Lh, Lt, Tsb,
    ...
    # -----------------------------------------------
    # Active soil (offset from concrete)
    ...
    # -----------------------------------------------
    # Concrete (drawn last, slightly thicker)
    ax.add_patch(Rectangle(
        (x0, y0), base_L, base_h,
    ...
    ax.set_aspect("equal")
    ax.axis("off")
    ax.set_title("Retaining Wall Geometry (Refined Graphics)")
